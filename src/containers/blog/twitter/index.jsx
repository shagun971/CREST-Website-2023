...
import { BlogWrap, BlogList, BlogListItem, BlogWrapper, LeftBox, RecentBlogWrap, FeaturedBlogWrap } from "./style";
                ...
                <Row>
                    ...
                    <Col lg={8}>
                        <Row>
                            <Col md={6} sm={12}>
                                <TwitterTweetEmbed
                                    tweetId={'1487246223212179456'} />
                            </Col>
                            <Col md={6} sm={12}>
                                <TwitterTweetEmbed
                                    tweetId={'1487015185738915845'} />
                            </Col>
